...
libid()
{
echo '<SELECT name="libid" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
libidwd()
{
echo '<SELECT name="libidwd" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
grep ^Library /etc/mhvtl/device.conf| cut -d ":" -f2| awk '{print $1}'| while read each; do
LIBRVI=`awk 'BEGIN{RS="" } /Library: '$each'/' /etc/mhvtl/device.conf| grep "Vendor identification:" | cut -d ":" -f2|awk '{print $1}'`
LIBRPI=`awk 'BEGIN{RS="" } /Library: '$each'/' /etc/mhvtl/device.conf| grep "Product identification" | cut -d ":" -f2|awk '{print $1}'`
LIBRSN=`awk 'BEGIN{RS="" } /Library: '$each'/' /etc/mhvtl/device.conf| grep "Unit serial number:" | cut -d ":" -f2|awk '{print $1}'`
...
tape()
{
echo '<SELECT name="tape" type="text" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
robotdev()
{
echo '<SELECT name="robotdev" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
drivedev()
{
echo '<SELECT name="drivedev" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
slot()
{
echo '<SELECT name="slot" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
slotf()
{
echo '<SELECT name="slotf" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
map()
{
echo '<SELECT name="map" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
mapf()
{
echo '<SELECT name="mapf" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
driveslotf()
{
echo '<SELECT name="driveslotf" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
driveslot()
{
echo '<SELECT name="driveslot" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
device()
{
echo '<SELECT name="device" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
devices()
{
echo '<SELECT name="device" type="text" style="color: #FFFFFF; background: #3300FF; font-weight: bold;" class="set_width" maxlength=100 >'
...
libdid()
{
echo '<SELECT name="libdid" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
target()
{
echo '<SELECT name="tid" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
...
if [ -z "$CHECK" ] ; then
echo '<OPTION>'0 : none exist, please create first!'</OPTION>'
exit 0
else
...
lun()
{
echo '<SELECT name="lun" min="1" type="number" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
if [ -f /usr/sbin/tgtadm ]; then
CMD="/usr/sbin/tgtadm"
else
CMD="../stgt.git/usr/tgtadm"
...
iscsiclient()
{
echo '<SELECT name="iqn" min="1" type="text" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
if [ -f /usr/sbin/tgtadm ]; then
CMD="/usr/sbin/tgtadm"
else
CMD="../stgt.git/usr/tgtadm"
...
if [ -z "$CHECK" ] ; then
echo '<OPTION>'No ACL defined'</OPTION>'
echo '</SELECT>'
else
...
echo '<SELECT name="patch" type="text" style="color:#FFFFFF; background-color: #3300FF;font-weight:bold;" required >'
