...
<input TYPE=HIDDEN name="vi" value="DELL" READONLY type="text">
Select Library Model:<select name="lpi" ><OPTION>PV-136T</OPTION></select><b><FONT COLOR="red">*</FONT></b>
<input TYPE=HIDDEN name="lprl" value="2.60" READONLY type="text">
...
Enter Media Barcode Prefix (Any unique 3 char only) i.e DEL : <input name="mp" value="DEL" required MAXLENGTH="3" SIZE=2 type="text"><b><FONT COLOR="red">*</FONT></b><br>
