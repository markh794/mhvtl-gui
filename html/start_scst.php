...
<?php
echo "<pre>Starting SCST Daemons:</pre>";
?>
<br>
...
<?php
$output = shell_exec('RUNNING=`sudo -u root -S ps -ef | egrep "scstd"|egrep -v egrep|  wc -l`; if [ $RUNNING -gt 0 ]; then echo "<img src="images/green_light.png" />" "STATE:<FONT COLOR="green"> Already RUNNING Exiting ... </FONT>";else echo "<img src="images/red_light.png" />" "STATE:<FONT COLOR="red"> STOPPED</FONT> :<FONT COLOR="green"> Starting ... </FONT></a>"; sudo -u root -S ../scripts/start_stop_scst start >/tmp/starting.scst;fi');
$file = "/tmp/starting.scst";
