...
<?php
echo "<pre><b>Show Library Configurations :</b></pre>";
?>
...
echo "<pre><b><FONT COLOR=#000000>Show configuration for library = $VAR1 </FONT></b></pre>";
?>
...
<form method="post" action="show.library.php">
