...
Enter Media Size (Megabytes) : <input name="size" min="500" type="number" value="2000" MAXSIZE="6" required >
<br>
...
Enter Cartridge Label (barcode) 8 char e.g. TES001L4 : <input name="pcl" type="text" value="XXX001L4" MAXSIZE="8" required ><a href="#" onClick="window.open('mhvtl.list.tapes.php', 'Deviceid', 'width = 600, height = 400');">Search</a>
<br>
