...
Select Library ID : <?php echo $libid;?><a href="#" onClick="window.open('find.device.id.php', 'Deviceid', 'width = 600, height = 400');">Search</a>
<br>
...
Enter Barcode (8 char.) <input name="pcl" type="text" value="XXX001L4" MAXSIZE="8" required ><a href="#" onClick="window.open('list.tapes.php', 'Deviceid', 'width = 600, height = 400');">Search</a>
<br>
