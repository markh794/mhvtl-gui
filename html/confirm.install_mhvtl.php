...
<td>
<form action="install_mhvtl.php" method="post" onsubmit="return ray.ajax()">
<input TYPE="submit" type="submit" class="sameSize" style="color: #0000FF" value=" Install ">
</form>
<td>
