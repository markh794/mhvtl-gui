...
HBA info :
<?php
$output = shell_exec('sudo -u root -S cat /sys/class/fc_host/host?/symbolic_name');
echo "<pre><p style=\"text-align:left;\"><b>$output</b></p></pre>";
?>

WWN :
<?php
$output = shell_exec('sudo -u root -S cat /sys/class/fc_host/host?/node_name');
echo "<pre><p style=\"text-align:left;\"><b>$output</b></p></pre>";
?>
