...
echo "<FONT COLOR=#FFFFFF> Linux SCSI target framework ( tgt ) </FONT><a href='update.php'><FONT COLOR=#00FFFF >$ver </FONT></a>";
...
echo "' '$output' '<form action='confirm.stop_stgt.php' method='post' ><input TYPE='submit' style='color: #FF0000' value='Shutdown'></form>'<form action='disable_stgt_scsi_target.php' method='post' ><input TYPE='submit' style='color: #0000FF' value='Disable'></form>";
