...
<?php
echo "<pre><b>Check for updates :</b></pre>";
?>
...
$output = shell_exec('sudo -u root -S ../scripts/install_stgt.sh check_updates >/tmp/check_updates_stgt.sh.out; cat /tmp/check_updates_stgt.sh.out');
