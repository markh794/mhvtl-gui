...
<input TYPE=HIDDEN name="vi" value="SONY" READONLY type="text" >
Select Library Model:<select name="lpi"><option>LIB-302</OPTION><option>LIB-152</OPTION><option>LIB-152E</OPTION></select><b><FONT COLOR="red">*</FONT></b>
<input TYPE=HIDDEN name="lprl" value="0500" READONLY type="text" />
<input TYPE=HIDDEN name="lusn" value=<?php echo $nextlid+40000000;?> READONLY MAXLENGTH="8" type="text" />
...
<input TYPE=HIDDEN name="dvi" value="SONY" READONLY type="text">
Select Drive Model: <select name="pi"><OPTION>SDX-900V</option><OPTION>SDX-700C</option><OPTION>SDX-500C</option></select><b><FONT COLOR="red">*</FONT></b>
<input TYPE=HIDDEN name="prl" value="0100" READONLY type="text">
<input TYPE=HIDDEN name="usn" value=<?php echo $nextlid+40000001;?>  READONLY type="text"></a>
...
Enter Media Type : <select name="mt" MAXLENGTH="2" type="text" ><OPTION>AIT4</option><OPTION>AIT3</option><OPTION>AIT2</option></select><b><FONT COLOR="red">*</FONT></b><br>
...
Enter Media Barcode Prefix (Any unique 3 char only) i.e SON : <input name="mp" value="SON" required MAXLENGTH="3" SIZE=2 type="text"><b><FONT COLOR="red">*</FONT></b><br>
