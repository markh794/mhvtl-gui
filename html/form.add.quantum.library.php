...
<input TYPE=HIDDEN name="vi" value="QUANTUM" READONLY type="text" >
Select Library Model:<select name="lpi"><option>DXi6700</OPTION><option>Scalar i6000</OPTION><option>Scalar i500</OPTION><option>PX720</OPTION><option>DX5000</OPTION></select><b><FONT COLOR="red">*</FONT></b>
<input TYPE=HIDDEN name="lprl" value="0029" READONLY type="text" />
...
Enter Media Barcode Prefix (1 char only) : <input name="mp" value="Q" style="text-transform: uppercase" required MAXLENGTH="1" SIZE=2 type="text"><b><FONT COLOR="red">*</FONT></b><br>
