...
Enter Element Number - Free Slot : <input name="vol" min="1" type="number" required ><a href="#" onClick="window.open('form.robot.status.php', 'Devices', 'width = 600, height = 400');">Search</a>
<br>
