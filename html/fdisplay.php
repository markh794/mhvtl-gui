...
echo '<form action="frame_a.php" method="post" onsubmit="return ray.ajax()"><input TYPE="submit" class=sameSize2 style="background-color:#cccccc; color: #000000; font-weight: bold" value=" Refresh " ></form>';
